...
# ╔═╡ 49677eb6-62ce-11ec-2a2e-7b220e48576b
begin
	using Yao
	using YaoPlots
end

# ╔═╡ f44f70fb-5510-4fd7-96a2-884dbecb8b85
begin
	bellcircuit = chain(2, put(1=>H), control(1, 2=>X))
	plot(bellcircuit)
end

# ╔═╡ 8325bf25-0ce9-41c2-a917-244c5931cdb6
q1 = ArrayReg(bit"00")

# ╔═╡ 03a4e6af-d9b9-4ab0-8fb7-fabf14ed6991
state(q1)

# ╔═╡ 7cdc83a7-d498-4f3d-8dee-08bfb7433c3d
q2 = q1 |> bellcircuit

# ╔═╡ ffb5d7f5-ded1-49b6-aebf-fe7f1117bcab
state(q2)

# ╔═╡ ef15a1bc-a8bc-4639-9206-4949b7b61b41
begin
...
# ╔═╡ 00c3b8af-b07a-497f-b100-fe9bd53cc37c
plot(qft(3))

# ╔═╡ 93c3a769-1f0d-47a4-9fb7-1937f9c5fbbd
state(ArrayReg(bit"101") |> qft(3))
...
git-tree-sha1 = "181649a492cbc256243a8521f67d367ff99230bb"
uuid = "5872b779-8223-5990-8dd0-5abbb0748c8c"
version = "0.6.5"

[[deps.YaoAPI]]
git-tree-sha1 = "6c4c67e8b606cce481c6c3f7bb4f06650e516c1f"
...
git-tree-sha1 = "c095f47ff9f2aab391bbd9edcf9c9917d2d244df"
...
git-tree-sha1 = "d65951c4b803bd8952cd740099a72042ed735502"
...
git-tree-sha1 = "153faa042fbfc0f310e53095b742bb37401726ed"
